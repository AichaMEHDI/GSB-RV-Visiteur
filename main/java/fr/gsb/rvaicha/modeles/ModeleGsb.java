package fr.gsb.rvaicha.modeles;
...
import fr.gsb.rvaicha.entites.Medicament;
import fr.gsb.rvaicha.entites.Motif;
import fr.gsb.rvaicha.entites.Praticien;
...
public class ModeleGsb {
	...
	private void peupler(){
		...
		this.lesRapportsVisites.add( new RapportVisite(1,"RAS",2,new GregorianCalendar(2018,1,3),new GregorianCalendar(2018,1,5),true)) ;
		...
		this.lesRapportsVisites.add( new RapportVisite(2,"RAS",4,new GregorianCalendar(2018,1,5),new GregorianCalendar(2018,1,8),false)) ;
	...
	//retourne un seule rapport de visite  .


	public RapportVisite getVisualiserRV(int id ){
